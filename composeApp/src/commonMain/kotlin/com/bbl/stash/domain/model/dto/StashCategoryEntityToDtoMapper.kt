...
object EntityToDtoMapper {
    fun StashCategory.mapToDto(): com.bbl.stash.domain.model.dto.StashCategory {
        return com.bbl.stash.domain.model.dto.StashCategory(
            categoryId = categoryId,
            categoryName = categoryName
        )
    }

    fun StashItem.mapToDto(): com.bbl.stash.domain.model.dto.StashItem {
        return com.bbl.stash.domain.model.dto.StashItem(
